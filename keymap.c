...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SPACE_MOUSE] = LAYOUT_planck_mit(
			KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,       KC_T, KC_Y,       KC_U,       KC_I,    KC_O,            KC_P,     KC_BSPC,
			KC_LSFT, KC_A,    KC_S,    KC_D,   KC_F,       KC_G, KC_M,       KC_H,       KC_J,    KC_K,            KC_L,     KC_BACKSLASH,
			KC_ESC,  KC_Z,    KC_X,    KC_C,   KC_V,       KC_B, KC_N,       KC_MINUS,   KC_COMM, KC_DOT,          KC_QUOTE, KC_ENT,
			KC_LCTL, _______, _______, KC_SPC, KC_MS_BTN1, /***/ KC_MS_BTN2, KC_MS_BTN3, _______, TG(SPACE_MOUSE), _______,  _______
			),
